...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { submission_status: @status.submission_status } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { submission_status: @status.submission_status } }
